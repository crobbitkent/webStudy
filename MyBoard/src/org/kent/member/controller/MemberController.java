...
package org.kent.member.controller;
...
import org.kent.member.dao.MemberDAO;
...
public class MemberController extends MultiController {
	...
	public String listGET(HttpServletRequest request, HttpServletResponse response) {
		log.info("member listGET"); // log.debug();	
		...
		try {
			...
			PageMaker pageMaker = new PageMaker(info, memberDAO.getTotal());
			
			List<Member> members= memberDAO.getList(info);
